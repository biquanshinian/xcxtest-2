...
Component({
  ...
  properties: {
    ...
    prefKeywordsExpanded: { type: Boolean, value: false },
    prefWatchExpanded: { type: Boolean, value: false },
    notifyMinutes: { type: Number, value: 30 },
    roadClosureAlert: { type: Boolean, value: true },
    keywordOptions: { type: Array, value: [] },
    watchAccountOptions: { type: Array, value: [] },
    keywordMap: { type: Object, value: {} },
    watchMap: { type: Object, value: {} },
    selectedKeywordCount: { type: Number, value: 0 },
    selectedWatchCount: { type: Number, value: 0 },
  ...
  methods: {
    ...
    emitOnTogglePrefKeywordsExpand(e) { this._emit('onTogglePrefKeywordsExpand', e) },
    emitOnTogglePrefWatchExpand(e) { this._emit('onTogglePrefWatchExpand', e) },
    emitOnTogglePrefKeyword(e) { this._emit('onTogglePrefKeyword', e) },
    emitOnTogglePrefEventAccount(e) { this._emit('onTogglePrefEventAccount', e) },
