...
Page({
  ...
  fillForm(session) {
    ...
    const patch = {
      form: {
        ...
        rocketNameZh: session.rocketNameZh || '',
    ...
    launchList.getUpcomingMissions(30, 0).then((res) => {
      ...
      const options = (res && res.list ? res.list : [])
        ...
        .map((x) => ({
          ...
          rocketName: (x._langPack && x._langPack.rocketNameEn) || x.rocketNameEn || x.rocketName || '',
          rocketNameZh: (x._langPack && x._langPack.rocketNameZh) || '',
  ...
  _applyMissionIndex(idx) {
    ...
    const patch = {
      ...
      'form.rocketNameZh': opt.rocketNameZh || '',
  ...
  onSave() {
    ...
    const body = {
      ...
      rocketNameZh: form.rocketNameZh || '',
