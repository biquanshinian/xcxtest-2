"""Pack rocket-compare-app with root-only POSIX zip names."""
from pathlib import Path
import zipfile

ROOT = Path(__file__).resolve().parent / "rocket-compare-app"
OUT = Path(__file__).resolve().parent / "rocket-compare.zip"
