...
check('启动预热开屏任务 logo 缓存', /warmSplashMissionSideData/.test(prefetch) && /_splash_mission_hit/.test(prefetch))
check('启动阶段不抢开屏带宽拉 upcoming', !/getUpcomingMissionsAny/.test(prefetch))
