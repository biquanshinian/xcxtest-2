...
assert.ok(checklist.itemCanScanFill(checklist.getItem('approval_form', 'small')))
assert.ok(checklist.itemCanScanFill(checklist.getItem('accept_sheet', 'small')))
assert.ok(checklist.itemCanSkipFilesAfterScan(checklist.getItem('accept_sheet', 'small')))
assert.ok(checklist.itemCanSkipFilesAfterScan(checklist.getItem('approval_form', 'small')))
