        ...
        <div class="splash-pool-layout">
          <div class="splash-upload-area">
            <div class="splash-pool-hint">
              最多 {{ MEDIA_MAX }} 个（图片/视频均可）。小程序每次冷启动会<strong>随机</strong>展示其中一条。视频保存后自动转 720p 预览（约 2.2Mbps，12 秒大约 3MB）。
...
import SplashNoticeEditor from '../../components/editors/SplashNoticeEditor.vue'
