      ...
      <el-table-column label="预览" width="100">
        <template #default="{ row }">
          <img
            ...
            alt=""
            title="点击查看大图"
            @click="previewMedia(row.url, { title: row.key })"
      ...
      <el-form-item label="结果">
        ...
        <div v-else>
          <div v-if="matchResult.ok">
            ...
            <img :src="matchResult.url" referrerpolicy="no-referrer" loading="lazy" alt="" title="点击查看大图" style="margin-top:8px;max-width:200px;max-height:200px;border:1px solid rgba(255,255,255,0.14);border-radius:6px;cursor:zoom-in;" @click="previewMedia(matchResult.url, { title: matchResult.key })" />
          </div>
          <div v-else>
