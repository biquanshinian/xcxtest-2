  ...
  <el-container class="layout-root theme-dark" :class="{ 'has-mobile-drawer-open': mobileMenuOpen }">
    ...
    <el-aside width="240px" class="layout-aside" :class="{ 'is-mobile-open': mobileMenuOpen }">
      ...
      >
        ...
        <el-sub-menu
          v-if="hasPerm('launch_data') || hasPerm('starship_status') || hasPerm('starship_progress') || hasPerm('starship_events') || hasPerm('tweet_monitor') || hasPerm('road_closure') || hasPerm('spacex_stats')"
          index="launch"
        >
          <template #title><span>发射与星舰</span></template>
          <el-menu-item v-if="hasPerm('launch_data')" index="/launch-data">发射数据</el-menu-item>
          ...
          <el-menu-item v-if="hasPerm('spacex_stats')" index="/spacex-stats">SpaceX 统计</el-menu-item>
        </el-sub-menu>
        <el-sub-menu
          v-if="hasPerm('live_mgmt') || hasPerm('push_notify') || hasPerm('launch_votes') || hasPerm('lunar_wishes') || hasPerm('astro_photos') || hasPerm('milestone_rewards') || hasPerm('knowledge_cards')"
          index="ops"
        >
          <template #title><span>运营互动</span></template>
          ...
          <el-menu-item v-if="hasPerm('knowledge_cards')" index="/knowledge-cards">知识卡</el-menu-item>
        </el-sub-menu>
        ...
        <el-sub-menu
          v-if="hasPerm('shop_feed') || hasPerm('carousel') || hasPerm('splash_screen') || hasPerm('announcements')"
          index="display"
        >
          <template #title><span>展示与店铺</span></template>
          ...
          <el-menu-item v-if="hasPerm('carousel')" index="/carousel">轮播图</el-menu-item>
        ...
        <el-sub-menu v-if="hasPerm('cos_storage') || hasPerm('global_config')" index="assets">
          <template #title><span>资源与 3D</span></template>
        ...
        <el-sub-menu
          v-if="hasPerm('global_config') || hasPerm('cloud_functions') || hasPerm('data_export') || hasPerm('users') || hasPerm('logs') || hasPerm('dashboard')"
          index="system"
        >
          ...
          <el-menu-item v-if="hasPerm('dashboard')" index="/figma-design">星舰基地追踪</el-menu-item>
        </el-sub-menu>
      </el-menu>
...
.layout-main :deep(.el-table) {
  ...
  --el-table-current-row-bg-color: rgba(139, 92, 246, 0.1);
...
html.dark {
  ...
  --el-color-primary-light-8: rgba(139, 92, 246, 0.22);
  --el-color-primary-light-9: rgba(139, 92, 246, 0.12);
  --el-color-primary-dark-2: #7C3AED;
  --el-bg-color: transparent;
  --el-bg-color-overlay: rgba(14, 17, 32, 0.92);
  ...
  --el-text-color-regular: rgba(255,255,255,0.78);
  --el-text-color-secondary: rgba(255,255,255,0.55);
  --el-text-color-placeholder: rgba(255,255,255,0.38);
  ...
  --el-border-color-dark: rgba(255,255,255,0.16);
  --el-color-white: #12141f;
