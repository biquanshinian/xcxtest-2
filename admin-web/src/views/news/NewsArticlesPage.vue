  ...
  <el-card>
      ...
      <div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;">
        <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;">
          ...
          <div style="display:flex;align-items:center;gap:8px;">
            <span style="font-size:13px;color:#909399;white-space:nowrap;">小程序展示手写稿</span>
    ...
    <el-table :data="list" stripe>
      ...
      <el-table-column label="来源" width="120" show-overflow-tooltip>
        <template #default="scope">{{ scope.row.newsSite || '-' }}</template>
      </el-table-column>
...
import ArticleRichEditor from '../../components/editors/ArticleRichEditor.vue'
