...
const routes = [
  ...
  { path: '/share/figma', component: () => import('../views/dashboard/FigmaSharePage.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'ip-reference-glb', component: () => import('../views/media/IpReferenceGlbPage.vue'), meta: { perm: 'cos_storage', refKind: 'ip' } },
      { path: 'vehicle-reference-glb', component: () => import('../views/media/IpReferenceGlbPage.vue'), meta: { perm: 'cos_storage', refKind: 'vehicle' } },
      ...
      { path: 'ops-tools', component: () => import('../views/system/OpsToolsPage.vue'), meta: { perm: 'global_config' } },
