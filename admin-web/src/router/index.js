...
const routes = [
  ...
  { path: '/share/figma', component: () => import('../views/FigmaSharePage.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'oa-content/strategies', component: () => import('../views/OaStrategiesPage.vue'), meta: { perm: 'oa_content' } },
      { path: 'oa-content/assets', component: () => import('../views/OaAssetsPage.vue'), meta: { perm: 'oa_content' } },
      { path: 'oa-content/config', component: () => import('../views/OaContentConfigPage.vue'), meta: { perm: 'oa_content' } },
      ...
      { path: 'watch-party', component: () => import('../views/WatchPartyPage.vue'), meta: { perm: 'watch_party' } },
      { path: 'watch-party-merchants', component: () => import('../views/WatchPartyMerchantsPage.vue'), meta: { perm: 'watch_party' } },
      { path: 'souvenir-cards', component: () => import('../views/SouvenirCardsPage.vue'), meta: { perm: 'watch_party' } },
